 ...
 *
 * Tambahan dan modifikasi @hasanudinhs
 * + fungsi truncate
 * + fungsi search mode boolean
 * + fix beberapa (disesuaikan kebutuhan tepatnya)
 * Di ubah: Agustus 2016
 */
class medoo
{
    // General
    ...
    {
        return $this->exec('TRUNCATE "'.$this->prefix.$table.'"');
    }
