...
<h3><span class="glyphicon glyphicon-briefcase"></span>  Planning Penjadwalan Perbaikan</h3>
<a class="btn" href="penjadwalan.php"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>
<div class="col-md-12">
</div>
...
<table class="table">
	...
	if(isset($_GET['startdate'])){
		...
		$brg=mysql_query("SELECT title, adddate(startdate, INTERVAL 22 day) AS planning FROM calendar");
	}
	$no=1;
